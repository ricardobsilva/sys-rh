...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { administrative_region_id: @district.administrative_region_id, name: @district.name }
    end
  ...
  test "should update district" do
    patch :update, id: @district, district: { administrative_region_id: @district.administrative_region_id, name: @district.name }
    assert_redirected_to district_path(assigns(:district))
  end
